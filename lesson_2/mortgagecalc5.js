...
const calculateMonthlyPayment = (loan, monthlyInterestRate, loanDurationMonths) => {
    if(monthlyInterestRate === 0){
        return loan / loanDurationMonths;
    } else {
        return loan * (monthlyInterestRate / (1 - Math.pow(1 + monthlyInterestRate), (-loanDurationMonths)));
    }
};

// Formats yeras and months and for display purposes
...
const displayPayment = (loan, displayedInterestRate, totalInterestAmount, totalCost, monthlyPayments, formattedLoanDuration) => {
    console.clear();
...
while(true){
    ...
    let monthlyPayments = calculateMonthlyPayment(loan, monthlyInterestRate, totalLoanDurationMonths);
    ...
    displayPayment(loan, displayedInterestRate, totalInterestAmount, totalCost, monthlyPayments, formattedLoanDuration);
